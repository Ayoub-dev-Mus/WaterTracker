...
import 'package:water_tracker/custom/waterLevel/Liquid_progress_indicator.dart';
import 'package:water_tracker/dbhelper/DataBaseHelper.dart';
import 'package:water_tracker/dbhelper/datamodel/WaterData.dart';
...
class _DrinkWaterLevelScreenState extends State<DrinkWaterLevelScreen>
  ...
  List<String> allDays =
      DateFormat.EEEE(getLocale().languageCode).dateSymbols.SHORTWEEKDAYS;
  ...
  _getDataFromDataBase() async {
    drinkWater = await DataBaseHelper.getTotalDrinkWater(
        DateFormat.yMd().format(currentDate).toString());
    drinkWaterHistory =
        ...
        children: [
          Container(
            ...
            child: CommonTopBar(
              ...
              this,
              subHeader: Languages.of(context)!.txtToday,
        ...
        children: [
          InkWell(
            ...
            child: Container(
              child: Image.asset(
                (num == 1)
                    ? 'assets/icons/water/ic_fill_100.webp'
                    : 'assets/icons/water/ic_empty_100.webp',
                scale: 3.5,
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              child: Image.asset(
                (num == 2)
                    ? 'assets/icons/water/ic_fill_150.webp'
                    : 'assets/icons/water/ic_empty_150.webp',
                scale: 3.5,
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              child: Image.asset(
                (num == 3)
                    ? 'assets/icons/water/ic_fill_250.webp'
                    : 'assets/icons/water/ic_empty_250.webp',
                scale: 3.5,
              ),
            ),
          ),
          InkWell(
            ...
            child: Container(
              child: Image.asset(
                (num == 4)
                    ? 'assets/icons/water/ic_fill_500.webp'
                    : 'assets/icons/water/ic_empty_500.webp',
                scale: 3.5,
              ),
            ),
          ),
              ...
              BarChartData(
                barTouchData: BarTouchData(
                  touchTooltipData: BarTouchTooltipData(
                      tooltipBgColor: Colur.tab_text.withOpacity(0.8),
  ...
  _selectedTextStyle() {
    return const TextStyle(
        color: Colur.txt_black, fontWeight: FontWeight.w400, fontSize: 14);
  }
  ...
  BarChartGroupData makeDrinkWaterGroupData(
    ...
    return BarChartGroupData(
      ...
      barRods: [
        BarChartRodData(
          toY: isTouched ? y + 1 : y,
          color: isTouched ? Colur.txt_grey : barColor,
          width: width,
  ...
  _selectedCommonIcon(double fullheight, double fullwidth, int num) {
    switch (num) {
      case 1:
        ...
        return 'assets/icons/water/ic_fill_100.webp';
      case 2:
        valueForIncrement = 150;
        return 'assets/icons/water/ic_fill_150.webp';
      case 3:
        valueForIncrement = 250;
        return 'assets/icons/water/ic_fill_250.webp';
      case 4:
        valueForIncrement = 500;
        return 'assets/icons/water/ic_fill_500.webp';
      default:
                ...
                PopupMenuButton(
                  ...
                  onSelected: (value) {
                    if (value != null && value == 1) {
                      setState(() {
                        DataBaseHelper.deleteTodayDrinkWater(
                            drinkWaterHistory[index]);
                        _getDataFromDataBase();
                      });
                    }
                  },
